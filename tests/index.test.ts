...
![Square 200x200](${INLINE_IMAGE_DATA_URL}#200x200)
![Logo 180x16](${INLINE_IMAGE_DATA_URL}#180x16)
![Explicit w h params](${INLINE_IMAGE_DATA_URL}#w=150&h=100)
`
...
![Test Image](${INLINE_IMAGE_DATA_URL}#70x70)
...
`
    ...
    try {
      ...
      console.error('TOC/Page Break test failed during conversion:', err)
      throw err
    }
...
2. Another numbered item`
    ...
    console.log(`✅ Lists test completed successfully! File saved to: ${outputPath}`)
...
- Bullet item 2`
    ...
    console.log(`✅ Advanced lists test completed! File saved to: ${outputPath}`)
